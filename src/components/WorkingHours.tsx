...
const WorkingHours = () => {
 ...
 <div>
        <ul className="m:space-y-4 lg:space-y-4 space-y-2  lg:w-full  mx-auto w-full   lg:mt-10   lg:text-[1.5rem] leading-6 text-[0.875rem]">
    <li className="grid grid-cols-3 items-center font-medium text-white">
      ...
      <span className=" text-end">Turnaround</span>
       ...
       <ul className=" lg:space-y-6 space-y-2  lg:w-full mx-auto    lg:text-[1.5rem] text-[0.75rem] text-white font-light">
    <li className="grid grid-cols-3 items-center ">
      <span className=" text-start">Dry cleaning</span>
      <img src="src\assets\icons\Vector 4.png" alt="" className=" lg:w-6  lg:h-4 w-3 h-2 mx-auto" />
   ...
   <div className="  lg:w-full h-[1px] bg-white mb-2  lg:mt-16 mt-10 mx-auto"></div>
   <div className="flex flex-col  lg:flex-row  lg:justify-between  ">
     <p className="text-start   lg:text-[1.5rem] mt-6 lg:mb-0 text-[0.875rem] font-medium">Collection and delivery </p>
     <div className="space-y-2  lg:space-y-4  lg:mt-12 text-[0.875rem]   lg:text-[1.5rem] mt-6">
        <p>
