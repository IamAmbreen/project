  ...
  return (
    <section className="h-100 text-customBlue bg-white pt-20">
        <div className="flex justify-end py-9">
            <div className="bg-customBlue md:h-[376px] lg:h-[376px] md:w-[975px] lg:w-[975px] md:px-16 lg:px-16 lg:py-16 md:py-16 h-[294px] w-[360px] px-8 py-8 text-white text-start">
                <h1 className=" md:text-6xl lg:text-6xl text-[24px] font-semibold ">Your Title</h1>
                <p className="md:mt-10 lg:mt-10 md:text-[16px] lg:text-[16px] font-light md:max-w-[550px] lg:max-w-[550px] text-[14px] ">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur feugiat, turpis ac feugiat tincidunt, ante orci sagittis erat, vitae dictum diam mi id velit. Nam condimentum, orci vitae feugiat imperdiet, massa tellus laoreet augue, id mattis velit lacus congue leo. Duis vehicula, libero vel ultrices varius, massa magna mattis enim, at laoreet enim elit quis quam.</p>
            </div>

        </div>

         <div className="flex justify-start py-9">
            <div className="bg-customBlue md:h-[376px] lg:h-[376px] md:w-[975px] lg:w-[975px] md:px-16 lg:px-16 lg:py-16 md:py-16h-[294px] w-[360px] px-8 py-8 text-white text-start">
                <h1 className=" md:text-6xl lg:text-6xl text-[24px] font-semibold text-center ">Your Title</h1>
                <p className="md:mt-10 lg:mt-10 md:text-[16px] lg:text-[16px] font-light md:max-w-[550px] lg:max-w-[550px] text-[14px] mx-auto ">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur feugiat, turpis ac feugiat tincidunt, ante orci sagittis erat, vitae dictum diam mi id velit. Nam condimentum, orci vitae feugiat imperdiet, massa tellus laoreet augue, id mattis velit lacus congue leo. Duis vehicula, libero vel ultrices varius, massa magna mattis enim, at laoreet enim elit quis quam.</p>
            </div>
        ...
        <div className="m-10 md:w-[803px] lg:w-[803px] w-[271px] mx-auto text-center md:text-[16px] lg:text-[16px] text-[14px]">
            <p>
