...
const Services = () => {
  ...
  return (
    <section className="h-100  bg-customBlue text-white py-12">
        <div className="md:w-[1192px] lg:w-[1192px] md:p-16 mx-auto text-center lg:p-16 ">
            <h2 className="text-center md:text-7xl lg:text-7xl text-[33px] md:w-[738px] lg:w-[738px] w-[316px] mx-auto font-semibold md:mt-20 lg:mt-20 md:m-20 lg:m-20 m-10">
        ...
        <div className="md:flex md:flex-row lg:flex lg:flex-row flex flex-col md:w-[1192px] lg:w-[1192px] md:h-[298px] lg:h-[298px] w-[305px] h-[1044px] mx-auto md:mb-14 lg:mb-14">
            ...
            <div className="md:w-[397px] lg:w-[397px] w-[306px] md:p-12 lg:p-12 p-8 border border-white-200 text-white mb-10 md:mb-0 lg:mb-0">
              <img src="src\assets\icons\number.png" alt="" className="justify-start mb-4"/>
              <h2 className="uppercase text-[32px] lg:w-[300px] md:w-[300px] w-[240px] font-semibold"> oxshott dry cleaners</h2>
            </div>
            <div className="md:w-[397px] lg:w-[397px] w-[306px] md:p-12 lg:p-12 p-8 md:border-r-0 lg:border-r-0 border border-white-200 text-white mb-10 md:mb-0 lg:mb-0">
              <img src="src\assets\icons\number.png" alt="" className="justify-start mb-4"/>
              <h2 className="uppercase text-[32px] lg:w-[300px] md:w-[300px] w-[240px] font-semibold"> weybridge cleaners</h2>
            </div>
          ...
          <img src="src\assets\icons\number.png" alt="" className="justify-start mb-4"/>
              <h2 className="uppercase text-[32px] lg:w-[300px] md:w-[300px] w-[240px] font-semibold"> leatherhead dry cleaners</h2>
        </div>
        </div>
