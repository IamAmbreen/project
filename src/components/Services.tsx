    ...
    <section className="h-100  bg-customBlue text-white lg:pt-35 pt-15 ">
        ...
        <div className=" hidden  lg:block lg:w-1/4 lg:h-full p-10 mx-auto border border-white-200 text-white lg:mb-45">
          <img src="src\assets\icons\number.png" alt="" className="justify-start mb-4 lg:h-[2.6467rem] lg:w-[2.6467rem]"/>
            ...
            <button
          type="button"
          className="flex gap-2 items-center text-customBlue bg-customYellow lg:text-[1.75rem]  text-[0.875rem] rounded-md lg:rounded-full  px-8 lg:px-22 lg:py-5 lg:font-inter lg:font-bold font-medium py-3 text-center  lg:transition-colors  lg:duration-300  lg:hover:bg-yellow-600"
