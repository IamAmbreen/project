...
const Pricing = () => {
  ...
  return (
    <section className="h-100 py-14 md:py-28 lg:py-28 bg-customBlue text-white ">
         ...
         <div className="hidden md:flex lg:flex md:px-32 md:py-16 md:justify-center md:mb-4 ">
             <button type="button" className=" flex gap-2 text-customBlue bg-customYellow items-center font-semibold lg:text-[1rem] md:text-[1rem] text-xs rounded-md lg:rounded-full md:rounded-full px-16 py-4 text-center  md:transition-colors lg:transition-colors md:duration-300 lg:duration-300 md:hover:bg-yellow-600 lg:hover:bg-yellow-600 " onClick={handlePriceListClick}><span>View Full Price List</span><img src="src\assets\icons\arrow-up-right.png" alt="" className="w-4 h-4" /></button>
            </div>
              <div className="flex flex-col md:flex-row lg:w-[73.88rem] lg:h-[30.37rem] md:w-[55.88rem] md:h-[23.37rem] md:mx-auto lg:mx-auto lg:flex-row md:gap-4 lg:gap-4 md:mb-16 lg:mb-16 mb-8">
  ...
  <ul className="space-y-5 md:text-xs lg:text-xl text-xs">
    <li className="font-medium lg:w-[8.55rem] md:w-[6.25rem] w-[6.25rem]"> Cleaned and ironed</li>
 ...
 <div className="lg:w-[23.88rem] md:w-[17.75rem] mb-5 md:mb-0 lg:mb-0 mx-auto p-7 border border-white-200  md:border-4 border-white-200 lg:border-4 border-white-200 text-white">
  ...
  <ul className="space-y-5 md:text-xs lg:text-xl text-xs">
    <li className="font-medium lg:w-[8.75rem] md:w-[6.25rem] w-[6.25rem]"> Wash,dry and fold</li>
    <li className="flex justify-between  font-light">
      <span className="flex items-center gap-2">
        <img src="src\assets\icons\Vector.png" alt="" /> <span>Shirt (Hanger)</span>
      </span>
    ...
    <li className="flex justify-between font-light">
      ...
      <span>£9</span>
             ...
             <div className=" flex justify-center md:mb-4 ">
               <p className='hidden md:block lg:block md:text-center  md:text-[1.625rem] md:font-light lg:text-center lg:text-[26px] lg:font-light md:text-white lg:text-white'> Free Collecting Laundry £20 Min Spend</p>
