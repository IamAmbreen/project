...
const Pricing = () => {
  ...
  return (
    <section className="h-100 py-14 md:py-28 lg:py-30 bg-customBlue text-white ">
         ...
         <div className="hidden md:flex lg:flex md:justify-center md:mb-4 lg:mb-20 ">
             <button type="button" className=" flex gap-2 text-customBlue bg-customYellow items-center font-bold lg:text-[1.5062rem] md:text-[1rem]  lg:rounded-full md:rounded-full lg:px-16 lg:py-7  md:px-32 md:py-16 text-center  md:transition-colors lg:transition-colors md:duration-300 lg:duration-300 md:hover:bg-yellow-600 lg:hover:bg-yellow-600 " onClick={handlePriceListClick}><span>View Full Price List</span><img src="src\assets\icons\arrow-up-right.png" alt="" className="w-4 h-4 lg:h-5 lg:w-5" /></button>
            </div>
  ...
  <ul className="space-y-5 md:text-xs lg:text-xl text-xs lg:mb-11 font-extralight">
    <li className="font-medium lg:w-full lg:pr-40 lg:pl-5 md:w-full w-full"> Cleaned and ironed</li>
  ...
  <ul className="space-y-5 md:text-xs lg:text-xl text-xs font-extralight">
    ...
    <li className="flex justify-between ">
      ...
      <span>£9</span>
             ...
             <button type="button" className=" md:hidden lg:hidden  flex gap-2 text-customBlue bg-customYellow items-center font-semibold text-xs px-10 py-4 text-center " onClick={handlePriceListClick}><span>View Full Price List</span><img src="src\assets\icons\arrow-up-right.png" alt="" className="w-4 h-4" /></button>
            </div>
