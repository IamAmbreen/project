...
<section className="h-100 flex flex-col md:flex-row lg-m:flex-row lg:flex-row xl:flex-row  items-center bg-customBlue text-white">
 ...
 <div className=" uppercase items-center  md:mb-10 lg-m:mb-12 lg:mb-20 xl:mb-36 font-bold md:tracking-tighter lg-m:tracking-tighter lg:tracking-tighter xl:tracking-tighter " style={{ fontSize: 'clamp(2rem, 5vw, 7.89rem)' , lineHeight: 'clamp(2.25rem, 5.5vw, 9rem)' }} >
 <p>Cobhem's dry</p>  
 <p> cleaning &</p>
 <p>laundary service</p>
 </div>
 <p className=" lg:hidden lg-m:hidden md:hidden text-[1.0625rem] px-22 mb-3 mt-2 font-light">
