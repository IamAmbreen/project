...
<div className=" flex justify-center lg:mt-12 mt-28 ">
              <button
          type="button"
          className="flex gap-2 items-center text-customBlue bg-customYellow lg:text-[1.75rem]  text-[0.875rem] rounded-md lg:rounded-full  px-8  lg:px-24 lg:py-5 lg:font-inter lg:font-bold font-medium py-3 text-center  lg:transition-colors  lg:duration-300  lg:hover:bg-yellow-600"
