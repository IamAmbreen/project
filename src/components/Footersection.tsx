...
const Footersection = () => {
  return (
    <section className=" md:bg-customBlue lg:bg-customBlue bg-white text-customBlue  md:text-white lg:text-white pb-0 md:px-52 lg:px-52 md:py-16 lg:py-16">
      <div className="md:flex md:h-[483px] lg:h-[483px] lg:flex w-full h-[795px] md:px-12 lg:pl-12 px-7  md:pt-6 lg:pt-6 pt-12">
                ...
                <div className="hidden md:block lg:block md:w-[409px] lg:w-[409px] md:h-[296px] lg:h-[296px]  md:mr-40 lg:mr-40">
                  ...
                  <ul className=" hidden md:block lg:block space-y-3 md:w-[600px] lg:w-[600px] md:h-[182px] lg:h-[182px] md:text-[20px] lg:text-[20px] mx-auto md:ml-52 lg:ml-56 md:mt-12 lg:mt-12">
                  <li className="md:grid md:grid-cols-3 lg:grid lg:grid-cols-3 items-center font-medium md:text-white lg:text-white text-customBlue md:gap-20 lg:gap-32">
                  <span className=" text-start">Services</span>
                  <span>About</span>
                  <span className="">Help</span>
                  </li>

                   <li className="md:grid md:grid-cols-3 lg:grid lg:grid-cols-3 items-center font-extralight text-white md:gap-20 lg:gap-32">
              ...
              <div className="bg-customBlue text-white md:ml-10 lg:ml-10 pl-5 h-[38px] lg:h-auto w-full flex items-center md:w-full lg:w-full   ">
                <a href="#" className="md:transition-opacity lg:transition-opacity md:lg:duration-300 lg:duration-300  md:hover:opacity-50 lg:hover:opacity-50 md:text-[20px] lg:text-[20px] md:w-[250px] lg:w-[250px] w-[120px] text-[10px]">Terms and Conditions</a>
                <span className="md:ml-24 lg:ml-24 ml-7 "><a href="#" className="md:transition-opacity lg:transition-opacity md:lg:duration-300 lg:duration-300  md:hover:opacity-50 lg:hover:opacity-50 md:text-[20px] lg:text-[20px] md:w-[200px] lg:w-[200px] w-[94px] text-[10px]">Privacy Policy</a></span>
                 ...
                 <a href="#" className="md:ml-auto lg:ml-auto ml-24 md:transition-opacity lg:transition-opacity md:lg:duration-300 lg:duration-300  md:hover:opacity-50 lg:hover:opacity-50"><img src="src\assets\icons\facebook.png" alt="" className="lg:w-[10px] lg:h-[20px] md:w-[10px] md-h[20px] h-[14px] w-[7px]"/></a>
